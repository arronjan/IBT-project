...
// Check if user is Admin - only admins can access reports
...
<body>
  <nav class="navbar">
    <div class="nav-container">
      ...
      <div class="nav-menu" id="navMenu">
        ...
        <a href="admin_reports.php" class="nav-link active">Reports</a>
    ...
    <div class="container">
      ...
      <div class="stats-grid">
        ...
        <div class="card">
          ...
          <p class="stat-number" id="revenueMonth">₱0</p>
      ...
      <div class="card">
        <div style="
          ...
          <div style="display: flex; gap: 12px; flex-wrap: wrap">
            <select id="statusFilter" onchange="filterBookings()" style="
                  padding: 8px 16px;
            ...
            <button onclick="loadAllBookings()" class="btn btn-sm" style="padding: 8px 16px">
              🔄 Refresh
            </button>
          </div>
        </div>
  ...
  <script>
      ...
      try {
        ...
        if (data.success) {
          ...
          document.getElementById("revenueMonth").textContent =
            "₱" + (data.stats.revenue_month || 0).toLocaleString();
          ...
          return `
              ...
              ? `
                ...
                : ""
                        ...
                        <button onclick="confirmCancel(${booking.booking_id}, '${booking.user_name}', '${booking.court_name}')" 
    ...
    function calculateBookingAmount(startTime, endTime) {
      ...
      return Math.round(hours * 250);
    }

    async function updateBookingStatus(bookingId, status, userName, courtName) {
      try {
        showLoading();
