    ...
    <div class="container">
      ...
      <div class="card" style="margin-bottom: 24px">
        <div style="display: flex; gap: 16px; flex-wrap: wrap">
          <input type="text" id="searchInput" placeholder="Search by name or email..." style="
                flex: 1;
                min-width: 250px;
                padding: 12px;
          ...
          (user) => `
            <tr>
              ...
              : "badge-pending"
                ...
                <td>
                    ${user.user_id === 1 || user.user_id === currentUserId
              ? `
                        <span style="color: #9ca3af; font-size: 14px;">Protected</span>
                    `
              : `
                        <button class="btn btn-sm btn-danger" onclick="deleteUser(${user.user_id}, '${user.name}')">
                            🗑️ Delete
                        </button>
                    `
            }
